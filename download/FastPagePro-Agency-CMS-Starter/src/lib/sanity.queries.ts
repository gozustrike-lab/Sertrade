// ============================================================
// FAST PAGE PRO STUDIO v2.0 — GROQ Queries (Centralized)
// All Sanity queries in a single file.
// ============================================================

// ── Image/Video fragments ──
...
export const ALL_SERVICE_CATEGORIES_QUERY = `
...
export const FEATURED_SERVICES_QUERY = `
  *[_type == "service" && featured == true] | order(order asc) {
    ${ALL_SERVICES_QUERY.replace("*[_type == \"service\"]", "placeholder").trim().replace("placeholder", "*[_type == \"service\" && featured == true]")}
  }[0..5]
`;
...
export const ALL_HERO_SLIDES_QUERY = `
  *[_type == "heroSlide"] | order(order asc) {
    ...
    backgroundVideoMp4 { ${FILE_FIELDS} },
    backgroundVideoWebm { ${FILE_FIELDS} },
    posterImage { ${IMAGE_FIELDS} },
    mobileFallbackImage { ${IMAGE_FIELDS} },
    videoAutoplay,
    videoMuted,
    videoLoop,
    ctaLabel,
