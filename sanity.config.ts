...
export default defineConfig({
  ...
  plugins: [
    ...
    presentationTool({
      ...
      resolve: {
        locations: {
          heroSlide: defineLocations({ type: "heroSlide", resolve: () => ({ locations: [{ title: "Inicio", href: "/" }] }) }),
          ...
          serviceCategory: defineLocations({ type: "serviceCategory", resolve: () => ({ locations: [{ title: "Servicios", href: "/servicios" }] }) }),
          ...
          siteSettings: defineLocations({ type: "siteSettings", resolve: () => ({ locations: [{ title: "Inicio", href: "/" }, { title: "Nosotros", href: "/nosotros" }, { title: "Contacto", href: "/#contacto" }] }) }),
        },
      },
    }),
  ],
