...
export interface SanityProject { _id: string; title: string; slug: string; coverImage?: SanityImage | null; gallery?: SanityImage[]; description?: PortableTextBlock[]; excerpt?: string; client?: string; location?: string; year?: string; area?: string; status?: "completed" | "in-progress" | "planned"; tags?: string[]; service?: { _id: string; title: string; slug: string } | null; featured?: boolean; order?: number; }
