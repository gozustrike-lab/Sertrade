...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.sertradeproyectos.com/proyectos',
  },
  openGraph: {
    title: 'Portafolio de Proyectos | Sertrade Design',
    ...
    url: 'https://www.sertradeproyectos.com/proyectos',
    images: [{ url: 'https://www.sertradeproyectos.com/og-proyectos-final.png', width: 1200, height: 630, alt: 'Portafolio de Proyectos - Sertrade Design' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Portafolio de Proyectos | Sertrade Design',
    description: 'Más de 200 proyectos entregados. Casos de éxito en arquitectura comercial, de salud y residencial en Perú, Colombia y Ecuador.',
    images: ['https://www.sertradeproyectos.com/og-proyectos-final.png'],
  },
};
